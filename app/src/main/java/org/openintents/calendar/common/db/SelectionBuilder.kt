...
package org.openintents.calendar.common.db
...
class SelectionBuilder {
     ...
     * specified in `column` will be replaced with `table.column` in the SQL `SELECT` clause.
     *
     ...
     */
    fun query(
        db: SQLiteDatabase, columns: Array<String>?, groupBy: String?,
    ...
    /**
     * Execute an `UPDATE` against database.
     *
     * @param db Database to query.
    ...
    /**
     * Execute `DELETE` against database.
     *
     * @param db Database to query.
     * @return The number of rows affected.
     */
